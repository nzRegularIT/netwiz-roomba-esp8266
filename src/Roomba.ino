...
void handle_root() {
	...
	String webpage = String("<!DOCTYPE HTML>") +
		...
		F("</table><br>") +
		F("Logs:<br><pre>") + logbuf +
		F("</pre><br>- <a href=\"/reboot\">Reboot</a><br>- <a href=\"/update\">Update</a><br><br>") +
